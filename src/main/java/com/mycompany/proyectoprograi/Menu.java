...
private void mostarArticulosEnTabla() {
    ...
    private void initComponents() {
        ...
        jLabel24.setText("Descripcion Producto");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel11Layout.createSequentialGroup()
                        .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel11Layout.createSequentialGroup()
                                ...
                                .addGap(74, 74, 74))
                            .addComponent(jTextField25, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)
...
try {
    ...
    try (FileWriter myWriter = new FileWriter(filePath);
         FileInputStream archivo = new FileInputStream("Empleados.bin");
...
try {
    ...
    try (FileWriter myWriter = new FileWriter(filePath);
         FileInputStream archivo = new FileInputStream("Articulos.bin");
         DataInputStream lectura = new DataInputStream(archivo)) {
...
try {
    ...
    try (FileWriter myWriter = new FileWriter(filePath);
         FileInputStream archivo = new FileInputStream("Proveedores.bin");
         DataInputStream lectura = new DataInputStream(archivo)) {
...
try {
    ...
    try (FileWriter myWriter = new FileWriter(filePath);
         FileInputStream archivo = new FileInputStream("Clientes.bin");
         DataInputStream lectura = new DataInputStream(archivo)) {
